...
#
#  $ bin/test -s pftx.theme -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src pftx.theme.testing.PFTX_THEME_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/pftx/theme/tests/robot/test_example.robot
#
